...
_sewa.expiredCheck(xavior, sewa)
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await xavior.setStatus(`${'JamerBot-MD'} | Runtime : ${runtime(uptime)}`)
...
╰────
╭─[ *MINAT CHAT* ]
├  🪀 wa.me/6285748600473?text=SEWABOT
╰────
╭─[ *PAYMENT* ]
├  DANA
├  GOPAY
...
╰────
╭─[ *MINAT CHAT* ]
├  🪀 wa.me/6285748600473?text=bang+mau+jadibot
╰────
╭─[ *PAYMENT* ]
├  DANA
├  GOPAY
...
let btn = [{
            ...
            break
case 'pulsa': {
                m.reply('NOPE PULSA: 085748600473')
            }
            break
case 'dana': {
                m.reply('NOPE DANA: 085748600473')
            }
            break
case 'gopay': {
...
let btn = [{
            ...
            case 'menu': case 'help': case '?': {
                anu = `${ucapanWaktu} Beban🙏\n\nI Am ${global.namabot}, Asal Lu Tau Ya Dek, Bot Ini Gak Secanggih Bot Ditahun 3000an.\n\nKarna ${global.namabot} Adalah Hasil Gabut Si Jamer El-Gato.\n\nKalau Beliau Makai Botnya Tapi Ngelag, Itu Karna Beliau Wibu🗿`
                let btn = [{
                                urlButton: {
                                    displayText: 'My Instagram',
                                    url: 'https://instagram.com/yudtya.w'
